import type { DurationToken, SpringIntent, TweenIntent } from "@cds/motion";
...
export const TYPE_ROLES: TypeRole[] = [
  {
    ...
    sample: "Catalogue specimen field",
  },
  {
    token: "h1",
    className: "type-h1",
  ...
  },
  {
    ...
    sample:
      "Lead paragraphs introduce a section with a slightly larger body size while staying in Geist.",
  },
  {
    token: "body",
    className: "type-body",
    ...
    sample:
      "Reading text stays at this size for catalogue notes, captions of record, and long-form technical copy.",
  },
  {
    token: "body-sm",
  ...
  },
  {
    ...
    sample: "--accent / packages/ui tokens.css",
  },
];
    ...
    swatches: [
      {
        token: "accent",
        cssVar: "--accent",
        use: "Tungsten emphasis. One accent only.",
...
export const CONTAINER_SPECIMENS: ContainerSpecimen[] = [
  {
    ...
    gutterVar: "--gutter",
    use: "Wide catalogues and this styleguide column",
  },
  {
    token: "wide",
    ...
    gutterVar: "--gutter",
    use: "Pages with media and tables",
  },
  {
    token: "reading",
...
export const POINTER_ACCENT_SPECIMEN = {
  size: 14,
